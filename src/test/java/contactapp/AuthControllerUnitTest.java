...
/**
 * Unit tests for {@link AuthController} logout behavior.
 * Validates that logout properly revokes all user tokens even when
 * refresh cookies are missing from the request.
 */
